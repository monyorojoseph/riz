    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bookingFee', models.PositiveIntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('LP', 'Normal lease payment'), ('RP', 'Normal rent payment'), ('BF', 'Booking Fee'), ('DP', 'Down payment long term lease')], default='LP', max_length=5)),
                ('amount', models.PositiveIntegerField()),
                ('createdOn', models.DateTimeField(auto_now_add=True)),
