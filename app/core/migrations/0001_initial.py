# Generated by Django 5.0.1 on 2024-01-02 21:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdOn', models.DateTimeField(auto_now_add=True)),
                ('type', models.CharField(choices=[('MC', 'Motor cycle'), ('VE', 'Just a regular vehicle sized car, suv, van etc'), ('LY', 'Big vehicle'), ('TR', 'Tractor')], default='VE', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('OR', 'Shop Owner'), ('AN', 'Shop Admin')], default='OR', max_length=5)),
                ('joinedOn', models.DateTimeField(auto_now_add=True)),
